// signup.js — ro'yxatdan o'tish formasi + fondagi "constellation" zarralar animatsiyasi
...
;(function initAuthNova() {
	...
	const draw = () => {
		...
		particles.forEach((p, i) => {
			context.beginPath()
			context.fillStyle = `rgba(37, 99, 235, ${p.opacity})`
			...
			for (let j = i + 1; j < particles.length; j += 1) {
				...
				if (distance < connectionDistance) {
					context.beginPath()
					context.strokeStyle = `rgba(245, 158, 11, ${(1 - distance / connectionDistance) * 0.2})`
